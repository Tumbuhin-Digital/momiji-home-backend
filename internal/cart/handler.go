...
func (h *Handler) SetupRoutes(router fiber.Router) {
	...
	optAuth.Patch("/items/variant", h.SetVariantQuantity)
...
// @Tags Cart
// @Accept json
// @Param request body SetVariantQuantityRequest true "Variant ID and Total Quantity"
// @Success 200 {object} response.Envelope
// @Router /cart/items/variant [patch]
